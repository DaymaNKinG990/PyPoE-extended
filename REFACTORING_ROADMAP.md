...
```
PyPoE/
├── poe/           # Ядро библиотеки (парсинг файлов Path of Exile)
│   ├── file/      # Парсеры форматов: .dat, .ggpk, .idl, .ot и др.
│   ├── sim/       # Симуляция игровой механики
│   └── constants.py
├── ui/            # GUI на PySide6 (✅ уже мигрировано)
│   ├── ggpk_viewer/
│   ├── launchpad/
│   └── shared/
├── cli/           # CLI экспортеры для wiki и данных
│   └── exporter/
...
### Проблема #1: Гигантские файлы спецификаций
...
**Решение:** Миграция в SQLite/JSON
