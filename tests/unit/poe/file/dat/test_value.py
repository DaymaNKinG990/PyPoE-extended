...
class TestDatValue:
    ...
    def test_is_pointer_true(self) -> None:
        ...
        dv = DatValue(value=None, child=child)
    ...
    def test_is_list_true(self) -> None:
        ...
        dv = DatValue(value=None, children=children)
    ...
    def test_comparison_type_error(self) -> None:
        ...
        dv = DatValue(value=42)
        list_dv = DatValue(value=None, children=[DatValue(value=1)])
